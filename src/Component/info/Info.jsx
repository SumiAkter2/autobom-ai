...
export const geekInfo = [
  {
    ...
    name: "TIME named AUTOBOM AI to the TIME100 Most Influential Companies list for making an extraordinary impact around the world.",
  },
  {
    id: 2,
    ...
    name: "Bloomberg interviews AUTOBOM AI Co-CEO Henrique Dubugras on AI-driven spend management and banking innovation. ",
  },
  {
    id: 3,
    ...
    name: "Fast Company covers AUTOBOM AI's expansion from corporate cards for startups to enterprise expense management software.",
  },
  {
    id: 4,
    ...
    name: "AUTOBOM AI named #2 on the 2023 top 50 disruptors list of innovative companies advancing breakthrough technology.",
  },
];
